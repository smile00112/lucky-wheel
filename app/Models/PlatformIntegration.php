...
class PlatformIntegration extends Model
{
    ...
    public static function getDefaultTelegramSettings(): array
    {
        ...
        return [
            ...
            'telegram.history_item_prize' => __('telegram.history_item_prize', [], $locale),
            'telegram.history_item_code' => __('telegram.history_item_code', [], $locale),
            'telegram.history_item_qr_image' => __('telegram.history_item_qr_image', [], $locale),
    ...
    public static function getDefaultVkSettings(): array
    {
        ...
        return [
            ...
            'vk.history_item_prize' => __('telegram.history_item_prize', [], $locale),
            'vk.history_item_code' => __('telegram.history_item_code', [], $locale),
            'vk.history_item_qr_image' => __('telegram.history_item_qr_image', [], $locale),
